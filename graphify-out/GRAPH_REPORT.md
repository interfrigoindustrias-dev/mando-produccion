...
## Corpus Check
- Corpus is ~45,651 words - fits in a single context window. You may not need a graph.

## Summary
- 330 nodes · 509 edges · 30 communities (26 shown, 4 thin omitted)
...
Cohesion: 0.10
Nodes (33): DESPACHOS, PRIORIDADES, ROWS, abrirModelo(), almacenBase(), almacenList(), bCarta, bStk (+25 more)
...
Cohesion: 0.23
Nodes (10): autoFechas(), autoPrioridades(), CAMPOS_PROCESO, ESCALA, fechaProgramada(), hoy0(), marcarInicioProduccion(), OFFSET (+2 more)
...
### Community 22 - "modelo.js"
Cohesion: 0.50
Nodes (3): MODELO_PANELES, MODELO_PUERTAS, MODELOS_DATOS

## Knowledge Gaps
- **46 isolated node(s):** `deploy.config.example.sh script`, `deploy.sh script`, `NUMERICOS`, `OFFSET`, `ESCALA` (+41 more)
...
- **Why does `ROWS` connect `Tableros y catalogo` to `Control de OPs`, `Constantes del modelo`, `Impresion`, `Vista de planta`, `Automatizaciones de fecha`, `calidad.js`?**
