# Graph Report - mando-produccion  (2026-08-28)

## Corpus Check
- Corpus is ~45,559 words - fits in a single context window. You may not need a graph.

## Summary
- 330 nodes · 471 edges · 33 communities (28 shown, 5 thin omitted)
...
## Knowledge Gaps
- **60 isolated node(s):** `deploy.config.example.sh script`, `deploy.sh script`, `NUMERICOS`, `VIEWS`, `LOG` (+55 more)
...
- **Why does `renderAlmacen()` connect `Tableros y catalogo` to `Constantes del modelo`, `Ayudantes de tableros`?**
