...
## Corpus Check
- 80 files · ~343,316 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 516 nodes · 756 edges · 47 communities (42 shown, 5 thin omitted)
...
Cohesion: 0.08
Nodes (34): separada(), separadaPara(), abrirModelo(), almacenBase(), almacenList(), bCarta, bStk, bTodas (+26 more)
...
### Community 12 - "Cliente de Google Sheets"
Cohesion: 0.36
Nodes (12): api(), ensureCols(), ensureGid(), ensureRows(), fetchRows(), NUMERICOS, repairNumeros(), repairStatus() (+4 more)
