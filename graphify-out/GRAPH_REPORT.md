...
## Corpus Check
- 77 files · ~332,371 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 448 nodes · 700 edges · 40 communities (35 shown, 5 thin omitted)
...
Cohesion: 0.10
Nodes (30): DESPACHOS, separada(), separadaPara(), abrirModelo(), almacenBase(), almacenList(), bCarta, bStk (+22 more)
