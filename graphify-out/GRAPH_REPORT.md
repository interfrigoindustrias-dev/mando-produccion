...
## Corpus Check
- Corpus is ~43,420 words - fits in a single context window. You may not need a graph.

## Summary
- 326 nodes · 495 edges · 29 communities (25 shown, 4 thin omitted)
...
Cohesion: 0.13
Nodes (24): DESPACHOS, abrirModelo(), almacenBase(), almacenList(), bCarta, bStk, bTodas, esModelo() (+16 more)

### Community 1 - "Control de OPs"
Cohesion: 0.13
Nodes (24): APERTURAS, PROCS, ROWS, SEL, editCampo(), fillLists(), filtered(), filtrosActivos() (+16 more)
...
Cohesion: 0.09
Nodes (16): BUMPERS, C, CFG, CON_RIEL, EMPAQUE_VISOR, ESPESORES, LOG_HEAD, MATERIALES (+8 more)
...
- **Why does `ROWS` connect `Control de OPs` to `Constantes del modelo`, `Automatizaciones de fecha`, `Impresion`, `Vista de planta`, `calidad.js`?**
