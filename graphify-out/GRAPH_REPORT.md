...
## Corpus Check
- 80 files · ~343,247 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 512 nodes · 813 edges · 42 communities (37 shown, 5 thin omitted)
...
Cohesion: 0.08
Nodes (35): autoPrioridades(), CAMPOS_PROCESO, COLUMNAS_NUEVAS, diasSinTocar(), ESCALA, ESPERA, hoy0(), marcarInicioProduccion() (+27 more)

### Community 1 - "Tableros y catalogo"
Cohesion: 0.10
Nodes (32): DESPACHOS, abrirModelo(), almacenBase(), almacenList(), bCarta, bStk, bTodas, celdaSeparar() (+24 more)
...
### Community 18 - "paneles-listas.js"
Cohesion: 0.21
...
### Community 27 - "meta.js"
Cohesion: 0.29
Nodes (3): META, META_DEF, META_HEAD

### Community 28 - "panel-de-puerta.js"
Cohesion: 0.43
...
### Community 34 - "paneles-almacen.js"
Cohesion: 0.60
...
- **Why does `ROWS` connect `Control de OPs` to `Tableros y catalogo`, `paneles-control.js`, `Cliente de Google Sheets`, `Constantes del modelo`, `Impresion`, `paneles-ficha.js`, `Vista de planta`?**
